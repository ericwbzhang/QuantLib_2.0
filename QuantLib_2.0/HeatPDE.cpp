...
HeatPDE_gridUpdate:: HeatPDE_gridUpdate(double coef, double xmin, double xmax, double tmax,
                                        long x_steps, long t_steps,
                                        const ROOT::Math::IBaseFunctionOneDim & down,
                                        const ROOT::Math::IBaseFunctionOneDim & left,
                                        const ROOT::Math::IBaseFunctionOneDim & right,
...
void HeatPDE_gridUpdate:: ForwardEuler(){
    double dx= fabs(xMAX- xMIN)/ N;
    double dt= tMAX/ M;
...
void HeatPDE_gridUpdate:: BackwardEuler(){
...
void HeatPDE_gridUpdate:: CrankNicolson(){
    double dx= fabs(xMAX- xMIN)/ N;
    double dt= tMAX/ M;
...
void HeatPDE_gridUpdate::BackwardEuler_SOR(double weight, double tol, long iterMAX){
    double dx= fabs(xMAX- xMIN)/N;
    double dt= tMAX/M;
...
void HeatPDE_gridUpdate::CrankNicolson_SOR(double weight, double tol, long iterMAX){
    double dx= fabs(xMAX- xMIN)/N;
    double dt= tMAX/M;
